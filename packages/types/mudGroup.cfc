<cfcomponent displayname="Microsoft UD Group" extends="farcry.core.packages.types.types" output="false" bsystem="true" hint="Users can be assigned to any number of groups.  Groups in turn are mapped to roles within the system which determine what a user has permission to do."
	bObjectBroker="true">
	
	<cfproperty ftSeq="1" ftFieldset="Microsoft UD Group" ftLabel="Title" 
				name="title" type="string" default="" 
				hint="The title of this group" />
				
	<cfproperty ftSeq="2" ftFieldset="Microsoft UD Group" ftRenderType="custom" ftLabel="Domains" 
...
" />
	...
	<cffunction name="delete" access="public" hint="Removes any corresponding entries in farUser" returntype="struct" output="false">
		...
		<cfset var qUser = "" />
		<cfset var oUser = createObject("component", application.stcoapi["mudUser"].packagePath) />
